                        ...
                        <div id="mobile-menu" className={`${showMenu ? "flex" : "hidden"} absolute dark:bg-gray-900  z-20 inset-0 md:hidden flex-col h-screen w-full`}>
                            ...
                            <div className="mt-6 p-4">
                                <ul className="flex flex-col space-y-6">
                                    <li>
                                        <Link to="/" className="dark:text-white flex items-center justify-between hover:underline text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800">                                             Home
                                            <div>

...
import { FaFacebookF, FaInstagram, FaTwitter, FaEnvelope, FaRss, FaPhoneAlt } from "react-icons/fa";
        ...
        <div className='dark:bg-gray-700 text-white py-2 font-light'>
            <div className='container mx-auto'>
                <div className='flex justify-between px-4'>
                    <div className=' items-center hidden md:flex'> <span className='flex items-center mr-2' ><FaPhoneAlt className='mr-2' /> +88 2534 3635</span>  <span className='flex items-center' ><FaEnvelope className='mr-2' />flyworld2020@gmail.com</span>  </div>

...
const TopPlace = (props) => {
    const { name, img, price, people, day, Location, night, info } = props?.item
    console.log(name);
    return (
        <div>
                ...
                <div className=" container text-left rounded-md  max-w-sm flex justify-center items-center  mx-auto content-div">
                    <div>
                        <div className='relative'>
                            <img className='rounded-3xl rounded-bl-none transition-shadow hover:shadow-2xl  tr' src={img} alt={name} />
                        </div>
                        <div className="py-8  rounded-b-md">
                            ...
                            <div className="mt-5 flex justify-between">
                                ...
                                <span className='flex items-center text-gray-700 font-semibold'><HiOutlineLocationMarker className='text-red-400 mr-2' />{Location}</span>
                            </div>
                            <p className='line-clamp-3 mt-2'>
                                {info}
                            </p>
                            <button className='bg-red-500 text-white font-semibold shadow-xl px-5 py-3 rounded-full mt-5 hover:shadow-sm transition-shadow '>
                                Book Now
                            </button>
                        </div>
                    </div>

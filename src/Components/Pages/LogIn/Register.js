...
const Register = () => {
    ...
    return (
        <div className="bg-gradient-to-tl from-green-200 to-indigo-200 w-full h-screen py-16 px-4">
            <div className="flex flex-col items-center justify-center">
                <div className='text-4xl font-bold'>
                    <img className='w-8/12 mx-auto' src="https://i.ibb.co/26hLdn6/logo-fly-black.png" alt="" />
                </div>
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <p className="text-sm mt-4 font-medium leading-none text-gray-500">
                        ...
                        <span className="text-sm font-medium leading-none underline text-gray-800 cursor-pointer">
                            <Link to="/login">Login hear</Link>
                        </span>
                    </p>
                    <button onClick={handelGoogleSinIn} aria-label="Continue with google" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10">
                    ...
                    <button aria-label="Continue with github" className="focus:outline-none cursor-wait focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                    ...
                    <button aria-label="Continue with twitter" className="focus:outline-none cursor-wait focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                    ...
                    <div>
                        ...
                        <input aria-label="enter name" type="text" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                    </div>
                    <div>
                    ...
                    <div className="mt-8">
                        <button aria-label="create my account" className="focus:ring-2 cursor-wait focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full"  >
                            Create my account
                        </button>
                    </div>
                </div>

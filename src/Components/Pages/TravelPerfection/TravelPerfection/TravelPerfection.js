    ...
    return (
        <div>
            <div className='container mx-auto py-8'>
                ...
                <p className='text-center px-4'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Distinctio, dolor!</p>
                <div className=' grid grid-cols-1 md:grid-cols-3 py-12  justify-between gap-8'>
                    <div className=''>
                        <HiChatAlt2 className='text-6xl mx-auto  hover:-rotate-45 transition-all ease-in-out text-red-300' />
                    ...
                    <div className='md:border-x-2'>
                        <HiLocationMarker className='text-6xl mx-auto hover:-rotate-45 transition-all ease-in-out  text-red-300' />
                        <h2 className='text-xl text-center font-semibold my-2'>Share Your Travel Location</h2>
                        <p className='w-6/12 text-center mx-auto'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Pariatur, dolorum?</p>
                    </div>
                    <div className=''>
                        <HiCalendar className='text-6xl text-center mx-auto  hover:-rotate-45 transition-all ease-in-out text-red-300' />
